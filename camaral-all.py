    ...
    try:
        while True:
            ...
            if now - last_infer_time >= infer_interval:
                ...
                if save_on_infer and object_count > 0:
                    ...
                    try:
                        ...
                        print(
                            f"已保存推理截图: {fname} (检测到 {object_count} 个目标)")
            ...
            if not save_on_infer and frame_idx % save_every_n == 0 and last_object_count > 0:
